                                        ...
                                        @if(!empty($employee_list[0]))
                                            @foreach ($employee_list as $list)
                                                <tr>
                                                    ...
                                                    <td>{{$list->emp_designation}}</td>
                                                    <td>{{$list->emp_level}}</td>
                                                    <td>{{ isset($list->emp_doj) ? date('d-M-Y', strtotime($list->emp_doj)) : ''}}</td>
                                                    <!-- <td>{{$list->states->name}}</td> -->
                                                    @if($list->cities != '')
                                                        <td>{{$list->cities->name}}</td>
                                                    @else
                                                        <td>No City Found</td>
                                                    @endif
                                                    <td>{{$list->emp_pincode}}</td>
                                                    <td>{{$list->emp_status}}</td>
                                                    <td><a href="{{url('admin/employee-edit/'.$list->id)}}"><i class="fa fa-pencil"></i></a><a class="emp_id" emp_id="{{$list->id}}" href="javascript:;"><i class="fa fa-trash"></i></a></td></i></a></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
